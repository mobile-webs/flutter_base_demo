...
class _DioPageState extends State<DioPage> {
  ...
  void _loadData() async {
    try {
      Response response = await Dio().get(TEST_URL);
      Autogenerated result = Autogenerated.fromJson(response.data);
      print(result.url);
      setState(() {
      ...
      home: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            Flexible(
              child: ListView(
                children: <Widget>[Text(data ?? '暂无数据')],
              ),
            )
          ],
        ),
...
class Autogenerated {
  ...
  Autogenerated({this.url, this.params, this.tabs});
